function updatePrintCount() {
    ...
    // Update localStorage
    localStorage.setItem('printInvestmentCount', printCountNumeric.toString());
}

// Initialize print count
var printInvestmentCount = parseInt(localStorage.getItem('printInvestmentCount'), 10); // Retrieve print count from localStorage
if (isNaN(printInvestmentCount)) {
    printInvestmentCount = 0; // Set default value if printCount is not a number or is null
}
...
document.addEventListener('DOMContentLoaded', function() {
    // Initialize print count
    var printCountInput = document.getElementById("printCountInput");
    printCountInput.value = 'II' + ('00000' + printInvestmentCount).slice(-5);
});
