...
function updatePrintCount() {
    ...
    // Update localStorage
    localStorage.setItem('printCheckCount', printCountNumeric.toString());
}

// Initialize print count
var printCheckCount = parseInt(localStorage.getItem('printCheckCount'), 10); // Retrieve print count from localStorage
if (isNaN(printCheckCount)) {
    printCheckCount = 102; // Set default value if printCount is not a number or is null
}
...
document.addEventListener('DOMContentLoaded', function() {
    // Initialize print count
    var printCountInput = document.getElementById("printCountInput");
    printCountInput.value = 'DT' + ('00000' + printCheckCount).slice(-5);
