...
var printSellerCount = parseInt(localStorage.getItem('printSellerCount'), 10); // Retrieve print count from localStorage
if (isNaN(printSellerCount)) {
    printSellerCount = 0; // Set default value if printCount is not a number or is null
}
