...
function updatePrintCount() {
    ...
    // Update localStorage
    localStorage.setItem('printCashCount', printCountNumeric.toString());
}

// Initialize print count
var printCashCount = parseInt(localStorage.getItem('printCashCount'), 10); // Retrieve print count from localStorage
if (isNaN(printCashCount)) {
    printCashCount = 102; // Set default value if printCount is not a number or is null
}
...
document.addEventListener('DOMContentLoaded', function() {
    // Initialize print count
    var printCountInput = document.getElementById("printCountInput");
    printCountInput.value = 'DT' + ('00000' + printCashCount).slice(-5);
